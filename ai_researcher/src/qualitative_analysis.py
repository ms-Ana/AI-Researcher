...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--engine", type=str, default="claude-3-5-sonnet-20240620", help="api engine"
    )
    parser.add_argument(
...
"""
        ...
        if counter == bucket_size:
            ...
            # Summarize the batch
            prompt, response, cost = summarize_reviews(
                reviews_concatenated, client, args.engine, args.seed
            )
            print(response)
            print("-------------------------------------\n")

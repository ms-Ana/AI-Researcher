...
def extract_structure(title, abstract, full_text, demos, openai_client, model, seed):
    prompt = (
        "Help me summarize a full paper into a structured format. The full paper is: \n"
    )
    prompt += "Title: " + title + "\n"
...
if __name__ == "__main__":
    ...
    for filename in tqdm(filenames):
        ...
        try:
            ...
            prompt, response, cost = extract_structure(
                title, abstract, full_text, demos, client, args.engine, args.seed
            )
            # print (prompt)
            # print ("\n\n")
            # print (response)
